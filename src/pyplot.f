c     author: Mike O'Neil <oneil@cims.nyu.edu>
c
...
ccc        write(iun87, '(a)') 'pt.axes().set_aspect("equal")'
...
c
 ...
 1600 continue
c
c        call prinf('inside pyimage2, npts = *', npts, 1)
c
        iun89=889
        open(unit=iun89,file=file9)
        do 2600 i=1,npts
...
c
        ...
        write(iun87,'(a)') 'import matplotlib.pyplot as pt'
        write(iun87,'(a)') 'import numpy as np'
c	    write(iun87,'(a)') 'import colormaps as cmaps'
        write(iun87,'(a)') ''
        write(iun87,'(a)') 'pt.rc("font", size=16)'
        write(iun87,'(a,a,a)') 'x = np.loadtxt("',file8,'")'
        write(iun87,'(a,i5,a,i5,a)') 
